...
<?php $__env->startSection('judul','Jurnal Umum - Sistem Informasi Akuntansi'); ?>
                    ...
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            ...
                            <div class="mb-3">
                                ...
                                <a href="<?php echo e(route('jurnal-umum.create')); ?>?page=<?php echo e(request('page')); ?>" class="btn btn-success" title="Tambah" data-toggle="tooltip"><i class="fas fa-plus"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="mb-3 table table-hover table-sm table-striped table-bordered">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $jurnal_umum; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td style="vertical-align: middle">
                                    <input type="checkbox" class="jurnal-umum-checkbox" id="delete<?php echo e($item->id); ?>" name="delete[]" value="<?php echo e($item->id); ?>">
                                </td>
                                <td style="vertical-align: middle">
                                    <a href="<?php echo e(route('jurnal-umum.edit', $item)); ?>?page=<?php echo e(request('page')); ?>" class="btn btn-sm btn-success" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                    <?php if($item->bukti): ?><a target="_blank" href="<?php echo e(route('jurnal-umum.show', $item)); ?>" class="btn btn-sm btn-primary" data-toggle="tooltip" title="Download Bukti"><i class="fas fa-download"></i></a><?php endif; ?>
                                </td>
                                <td style="vertical-align: middle; text-align: center"><?php echo e(tgl($item->tanggal)); ?></td>
                                <td style="vertical-align: middle; white-space: normal"><?php echo e($item->keterangan); ?></td>
                ...
                <?php echo e($jurnal_umum->links('layouts.footers.pagination')); ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-0">
                <form class="d-inline" action="<?php echo e(route("jurnal-umum.laporan")); ?>" method="get">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#delete', function(){
            ...
            if (confirm("Apakah anda yakin ingin menghapus data ini?")) {
                ...
                if (id.length > 0) {
                    $.ajax({
                        url     : "<?php echo e(route('jurnal-umum.destroys')); ?>",
                        method  : 'delete',
                        data    : {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Steffy\akuntansi\akuntansi\resources\views/jurnal-umum/index.blade.php ENDPATH**/ ?>