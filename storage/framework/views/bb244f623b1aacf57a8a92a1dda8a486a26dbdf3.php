...
<?php $__env->startSection('judul','Login - Sistem Informasi Akuntansi'); ?>
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-danger' : ''); ?> mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Email')); ?>" type="email" name="email" value="<?php echo e(old('email','admin@argon.com')); ?>" required autofocus>
                                </div>
                            ...
                            <div class="form-group<?php echo e($errors->has('password') ? ' has-danger' : ''); ?>">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password" placeholder="<?php echo e(__('Password')); ?>" type="password" value="<?php echo e(old('password','secret')); ?>" required>
                                </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg-default'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Steffy\akuntansi\akuntansi\resources\views/auth/login.blade.php ENDPATH**/ ?>